            ...
            <div className={styles.topDiv}>
              ...
              <div>
                ...
                <h3 className={styles.addContent}>
                  D.No. 8-19-57, Gopal Nagar, Beside Treasury Office Yettu
                  Bridge Road, Vizianagaram-535003 (A.P.) <br />
                  Cell: 9701523640, 8756314575.:: E-mail:
                  visakhagoldentransport@gmail.com{" "}
                </h3>
              </div>
            </div>
            <form onSubmit={() => {}} className={styles.wrap}>
              <div className={styles.rapeFlex}>
                <div className={styles.formDataHandle}>
                    ...
                    <div className={styles.formSection1}>
                      <div className={styles.demurrageSection}>
                        ...
                        <div className={styles.demurrageSec1}>
                          <h1 className={styles.overAllFontSizeInner}>
                      ...
                      <div className={styles.noteSection}>
                        ...
                        >
                          <h1 className={styles.overAllFontSizeInner}>
                            The Consignment covered by this Lorry Receipt shall
                            be stored at the destination under the control of
                            the Transport Operator and shall be delivered to or
                            to the order of the Consignee Bank whose name is
                            men- tioned in the Lorry Receipt. It will under no
                            circum- stances be delivered to anyone without the
                            written authority from the Consignee Bank or its
                            order, en- dorsed on the Consignee copy or on a
                            separate Letter
                          </h1>
                        </div>
                      </div>
                      ...
                      <div className={styles.CONSIGNEESection}>
                        ...
                        <div className={styles.CONSIGNEESec1}>
                          ...
                          >
                            ...
                            <span>(Delete Whichever is inapplicable)</span>
                          </h1>
                        </div>
                        <hr className={styles.overAllHr} />
                      </div>
                        ...
                        <div className={styles.insuranceSec1}>
                          <div className={styles.demurrageSec1}>
                            <p style={{ fontSize: "17px", fontWeight: 600 }}>
                              The consignor has stated that he has not insured
                              the consignment OR he has insured the consignment
                              Company
                            </p>
                    ...
                    <div className={styles.demurrageSection}>
                      <div className={styles.cautionSection}>
                        ...
                        >
                          <h1 style={{ fontSize: "12px" }}>
                            The Consignment will not be detained, diverted, to
                            out Commigen Banks Wris- Sen permission, Will be
                      ...
                      <div className={styles.cautionAddressSection}>
                        ...
                        <div className={styles.verticalWrap}>
                          <div
                            className={styles.sideInputWrap}
                            style={{ fontSize: "12px", marginBottom: "10px" }}
                          >
                            <p style={{ fontSize: "20px" }}>No.</p>
                            <input
                              name="uniqueNumber"
                  ...
                  <div className={styles.cosinSecDiv}>
                    <div className={styles.demurrageSection1}>
                      <div className={styles.sideInputWrap}>
                ...
                <div className={styles.insuranceSec1}>
                  <div className={styles.demurrageSection}>
                    <div className={styles.cautionSection}>
                      ...
                      >
                        Address of issuing office or name and address of agenta{" "}
                      </h1>
                      <hr className={styles.overAllHr} />
